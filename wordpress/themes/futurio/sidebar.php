<?php if ( is_active_sidebar( 'futurio-sidebar' ) || ( is_archive() || is_search() ) && is_active_sidebar( 'futurio-archive-sidebar' ) ) { ?>
	<aside id="sidebar" class="<?php if(null!==get_field('color')) echo get_field('color'); else echo "green"; ?> col-md-<?php echo absint( get_theme_mod( 'sidebar_size', '3' ) ) ?> <?php futurio_sidebar_position( 'sidebar' ) ?>">
		<?php
